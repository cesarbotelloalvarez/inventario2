...
const links = [
  { href: "/", label: "Dashboard" }, { href: "/articulos", label: "Herramientas" }, { href: "/fuera-inventario", label: "Prestado" }, { href: "/asignados", label: "Asignado" }, { href: "/trabajadores", label: "Trabajadores" }, { href: "/auditorias", label: "Auditorías" }, { href: "/historial", label: "Historial" },
];
