...
const links = [
  { href: "/", label: "Dashboard" }, { href: "/articulos", label: "Herramientas" }, { href: "/fuera-inventario", label: "Retorno" }, { href: "/trabajadores", label: "Trabajadores" }, { href: "/auditorias", label: "Auditorías" }, { href: "/historial", label: "Historial" },
];
