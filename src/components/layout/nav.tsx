...
const links = [
  { href: "/", label: "Dashboard" }, { href: "/articulos", label: "Artículos" }, { href: "/articulos/ocultos", label: "Ocultos" }, { href: "/fuera-inventario", label: "Fuera de inventario" }, { href: "/trabajadores", label: "Trabajadores" }, { href: "/auditorias", label: "Auditorías" }, { href: "/historial", label: "Historial" },
];
